...
def main():
	...
	X_test_transform = get_embedding_vector(tweet_test_text_vector, embedding_file)
	...
	np.savetxt(test_file+'_results.tsv', out_data, fmt='%s\t%s', delimiter='\t')

	with codecs.open(test_file+'_results_f8.tsv', 'w', 'utf-8') as f8_obj:

		with codecs.open(test_file+'_results.tsv', 'r', 'utf-8') as prediction_obj:
