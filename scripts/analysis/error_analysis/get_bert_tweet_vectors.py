...
def convert_embedding_2D(json_input, position_dict, fp_fn_position_dict):
	...
	ax1.axis('equal')  
	plt.tight_layout()
	plt.savefig('/Users/aggarwalpiush/github_repos/tweetnewsdetection/data/bert_embeddings/textwreply_test_data/t-SNE_bert_text_100_pie.png')
...
#Label each datapoint with the word it corresponds to
	...
	plt.savefig('/Users/aggarwalpiush/github_repos/tweetnewsdetection/data/bert_embeddings/textwreply_test_data/t-SNE_bert_text_100.png')
...
def main():
	...
	convert_embedding_2D(bert_file_wrply, position_dict, fp_fn_position_dict2)
